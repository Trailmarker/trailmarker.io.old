...
var o10094 = temp__5455__auto__;
var temp__5455__auto____$1 = (o10094["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o10095 = temp__5455__auto____$1;
return (o10095["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__9667__auto__ = f;
return (o__9667__auto__["toString"]).call(o__9667__auto__);
} else {
return "";
}
}catch (e10119){var _ = e10119;
return "";
}});
...
try{var o__9667__auto___10628 = t;
(o__9667__auto___10628["cljs$lang$ctorPrWriter"]).call(o__9667__auto___10628,t,writer);
}catch (e10144){var __10629 = e10144;
}
...
var char_code = (function (){var o__9667__auto__ = (new String(char$));
return (o__9667__auto__["charCodeAt"]).call(o__9667__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__9667__auto__ = String;
return (o__9667__auto__["fromCharCode"]).call(o__9667__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10189 = num_code;
switch (G__10189) {
case (1):
return (185);
...
var o__9667__auto__ = String;
return (o__9667__auto__["fromCharCode"]).call(o__9667__auto__,superscript_code);
});
/**
...
}catch (e10194){var _e__9674__auto__ = e10194;
return false;
}})())){
...
var vec__10198 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10198,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o10232 = temp__5455__auto__;
var temp__5455__auto____$1 = (o10232["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o10233 = temp__5455__auto____$1;
return (o10233["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4641__auto___10670 = arguments.length;
var i__4642__auto___10671 = (0);
while(true){
if((i__4642__auto___10671 < len__4641__auto___10670)){
args__4647__auto__.push((arguments[i__4642__auto___10671]));

var G__10672 = (i__4642__auto___10671 + (1));
i__4642__auto___10671 = G__10672;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__10252){
var vec__10254 = p__10252;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10254,(0),null);
...
var G__10673 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__10674 = cljs.core.butlast(remaining_tokens);
name_tokens = G__10673;
remaining_tokens = G__10674;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10242){
var G__10243 = cljs.core.first(seq10242);
var seq10242__$1 = cljs.core.next(seq10242);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10243,seq10242__$1);
});
...
var vec__10276 = cljs.core.split_with((function (p1__10273_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__10273_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10276,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10276,(1),null);
...
var vec__10287 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10287,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10287,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__10690 = cljs.core.rest(remaining_tokens);
var G__10691 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__10690;
name_tokens = G__10691;
continue;
} else {
...
var vec__10309 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10309,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10309,(1),null);
var vec__10312 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10312,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10312,(1),null);
var vec__10315 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10315,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10315,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10315,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10315,(3),null);
...
var vec__10329 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10329,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10329,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10329,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10329,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10329,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10329,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__10338 = temp__5455__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10338,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10338,(1),null);
var vec__10343 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10343,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10343,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__10354 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__10354) : devtools.munging.parse_fn_info_deep.call(null,G__10354));
})()));
}
} else {
return fn_info;
...
var G__10705 = (arity + (1));
var G__10706 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__10398){
var vec__10399 = p__10398;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10399,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10399,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__10446_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__10447_SHARP_);
...
args__4647__auto__.push((arguments[i__4642__auto___10721]));

var G__10725 = (i__4642__auto___10721 + (1));
i__4642__auto___10721 = G__10725;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__10483){
var vec__10484 = p__10483;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10484,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq10461){
var G__10462 = cljs.core.first(seq10461);
var seq10461__$1 = cljs.core.next(seq10461);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10462,seq10461__$1);
});
...
var G__10500 = arg;
var G__10500__$1 = (((G__10500 instanceof cljs.core.Keyword))?G__10500.fqn:null);
switch (G__10500__$1) {
...
var map__10547 = options;
var map__10547__$1 = (((((!((map__10547 == null))))?(((((map__10547.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10547.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10547):map__10547);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10547__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10547__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10547__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10547__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__10548 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10548,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10548,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10548,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10548,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10548,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10548,(5),null);
...
var o__9667__auto__ = f;
return (o__9667__auto__["getBasis"]).call(o__9667__auto__);
});
/**
...
}catch (e10564){var _e__9674__auto__ = e10564;
...
var G__10746 = (obj[cljs.core.first(path)]);
var G__10747 = cljs.core.rest(path);
obj = G__10746;
path = G__10747;
continue;
} else {
...
return (function (accum,p__10585){
var vec__10586 = p__10585;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10586,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10586,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__10597){
var vec__10599 = p__10597;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10599,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10599,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10599,(2),null);
...
return (function (p__10615){
var vec__10616 = p__10615;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10616,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10616,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__10616,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__10611_SHARP_){
return (obj[cljs.core.first(p1__10611_SHARP_)]);
});})(name,sorted_matches,vec__10616,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
