...
var len__4641__auto___10707 = arguments.length;
var i__4642__auto___10708 = (0);
while(true){
if((i__4642__auto___10708 < len__4641__auto___10707)){
args__4647__auto__.push((arguments[i__4642__auto___10708]));

var G__10709 = (i__4642__auto___10708 + (1));
i__4642__auto___10708 = G__10709;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq10697){
var G__10698 = cljs.core.first(seq10697);
var seq10697__$1 = cljs.core.next(seq10697);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10698,seq10697__$1);
});
...
return (p1__10700_SHARP_ === object);
});})(history))
,history);
});
