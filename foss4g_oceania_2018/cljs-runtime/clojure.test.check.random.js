...
var x__4347__auto__ = (((rng == null))?null:rng);
var m__4348__auto__ = (clojure.test.check.random.rand_long[goog.typeOf(x__4347__auto__)]);
if((!((m__4348__auto__ == null)))){
return (m__4348__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4348__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4348__auto__.call(null,rng));
} else {
var m__4348__auto____$1 = (clojure.test.check.random.rand_long["_"]);
if((!((m__4348__auto____$1 == null)))){
return (m__4348__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__4348__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__4348__auto____$1.call(null,rng));
} else {
...
var x__4347__auto__ = (((rng == null))?null:rng);
var m__4348__auto__ = (clojure.test.check.random.rand_double[goog.typeOf(x__4347__auto__)]);
if((!((m__4348__auto__ == null)))){
return (m__4348__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4348__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4348__auto__.call(null,rng));
} else {
var m__4348__auto____$1 = (clojure.test.check.random.rand_double["_"]);
if((!((m__4348__auto____$1 == null)))){
return (m__4348__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__4348__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__4348__auto____$1.call(null,rng));
} else {
...
var x__4347__auto__ = (((rng == null))?null:rng);
var m__4348__auto__ = (clojure.test.check.random.split[goog.typeOf(x__4347__auto__)]);
if((!((m__4348__auto__ == null)))){
return (m__4348__auto__.cljs$core$IFn$_invoke$arity$1 ? m__4348__auto__.cljs$core$IFn$_invoke$arity$1(rng) : m__4348__auto__.call(null,rng));
} else {
var m__4348__auto____$1 = (clojure.test.check.random.split["_"]);
if((!((m__4348__auto____$1 == null)))){
return (m__4348__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__4348__auto____$1.cljs$core$IFn$_invoke$arity$1(rng) : m__4348__auto____$1.call(null,rng));
} else {
...
var x__4347__auto__ = (((rng == null))?null:rng);
var m__4348__auto__ = (clojure.test.check.random.split_n[goog.typeOf(x__4347__auto__)]);
if((!((m__4348__auto__ == null)))){
return (m__4348__auto__.cljs$core$IFn$_invoke$arity$2 ? m__4348__auto__.cljs$core$IFn$_invoke$arity$2(rng,n) : m__4348__auto__.call(null,rng,n));
} else {
var m__4348__auto____$1 = (clojure.test.check.random.split_n["_"]);
if((!((m__4348__auto____$1 == null)))){
return (m__4348__auto____$1.cljs$core$IFn$_invoke$arity$2 ? m__4348__auto____$1.cljs$core$IFn$_invoke$arity$2(rng,n) : m__4348__auto____$1.call(null,rng,n));
} else {
...
var G__10992 = z;
if(((24) > (function (){var G__10994 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__10994) : clojure.test.check.random.longs.bit_count.call(null,G__10994));
})())){
return clojure.test.check.random.longs.bit_xor(G__10992,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__10992;
}
});
...
var G__11039 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__11040 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__11039;
ret = G__11040;
continue;
}
...
clojure.test.check.random.JavaUtilSplittableRandom.cljs$lang$ctorPrWriter = (function (this__4290__auto__,writer__4291__auto__,opt__4292__auto__){
return cljs.core._write(writer__4291__auto__,"clojure.test.check.random/JavaUtilSplittableRandom");
});
...
return (new clojure.test.check.random.JavaUtilSplittableRandom(clojure.test.check.random.golden_gamma,(function (){var or__4047__auto__ = clojure.test.check.random.longs.__GT_long(seed);
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11011__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__11014 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11014,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11014,(1),null);
