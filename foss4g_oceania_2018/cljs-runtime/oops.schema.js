...
var G__12853 = cljs.core.first(element_str);
switch (G__12853) {
case "?":
arr.push((1));
...
var G__12875 = cljs.core.next(items);
items = G__12875;
continue;
} else {
return null;
...
var G__12880 = cljs.core.next(items);
items = G__12880;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__12867 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__12867) : is_valid_QMARK_.call(null,G__12867));
})())){
var G__12888 = cljs.core.next(cljs.core.next(items));
items = G__12888;
continue;
} else {
return true;
...
switch (G__12870) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,((function (G__12870){
return (function (p1__12868_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12868_SHARP_,(2));
});})(G__12870))
))){
...
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__12869_SHARP_,(1));
});})(G__12870))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12870)].join('')));
