...
clojure.test.check.rose_tree.RoseTree.cljs$lang$ctorPrWriter = (function (this__4290__auto__,writer__4291__auto__,opt__4292__auto__){
return cljs.core._write(writer__4291__auto__,"clojure.test.check.rose-tree/RoseTree");
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__10954 = (n - (1));
var G__10955 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__10954,G__10955) : clojure.test.check.rose_tree.exclude_nth.call(null,G__10954,G__10955));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__10961 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__10961) : f.call(null,G__10961));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10958_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__10958_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__10958_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10963_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__10963_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__10963_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__10964_SHARP_){
var G__10966 = clojure.test.check.rose_tree.root(p1__10964_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__10966) : pred.call(null,G__10966));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__4434__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__10968(s__10969){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__10975 = cljs.core.first(xs__6012__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10975,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10975,(1),null);
var iterys__4430__auto__ = ((function (s__10969__$1,vec__10975,rose,index,xs__6012__auto__,temp__5457__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__10968_$_iter__10970(s__10971){
return (new cljs.core.LazySeq(null,((function (s__10969__$1,vec__10975,rose,index,xs__6012__auto__,temp__5457__auto__){
return (function (){
var s__10971__$1 = s__10971;
while(true){
var temp__5457__auto____$1 = cljs.core.seq(s__10971__$1);
if(temp__5457__auto____$1){
var s__10971__$2 = temp__5457__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__10971__$2)){
var c__4432__auto__ = cljs.core.chunk_first(s__10971__$2);
var size__4433__auto__ = cljs.core.count(c__4432__auto__);
var b__10973 = cljs.core.chunk_buffer(size__4433__auto__);
if((function (){var i__10972 = (0);
while(true){
if((i__10972 < size__4433__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4432__auto__,i__10972);
cljs.core.chunk_append(b__10973,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__11004 = (i__10972 + (1));
i__10972 = G__11004;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__10973),clojure$test$check$rose_tree$permutations_$_iter__10968_$_iter__10970(cljs.core.chunk_rest(s__10971__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__10973),null);
}
} else {
var child = cljs.core.first(s__10971__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__10968_$_iter__10970(cljs.core.rest(s__10971__$2)));
}
} else {
return null;
}
...
});})(s__10969__$1,vec__10975,rose,index,xs__6012__auto__,temp__5457__auto__))
,null,null));
});})(s__10969__$1,vec__10975,rose,index,xs__6012__auto__,temp__5457__auto__))
;
var fs__4431__auto__ = cljs.core.seq(iterys__4430__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__4431__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4431__auto__,clojure$test$check$rose_tree$permutations_$_iter__10968(cljs.core.rest(s__10969__$1)));
} else {
var G__11006 = cljs.core.rest(s__10969__$1);
s__10969__$1 = G__11006;
continue;
}
} else {
return null;
...
return iter__4434__auto__(cljs.core.map.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,roses,cljs.core.range.cljs$core$IFn$_invoke$arity$0()));
});
/**
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10983_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__10983_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__10983_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__10986_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__10986_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__10986_SHARP_));
