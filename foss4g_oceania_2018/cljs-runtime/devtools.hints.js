...
var G__10759 = cljs.core.PersistentArrayMap.EMPTY;
var G__10760 = native_stack_trace;
var G__10761 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__10762 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__10759,G__10760,G__10761,G__10762) : cljs.stacktrace.parse_stacktrace.call(null,G__10759,G__10760,G__10761,G__10762));
});
...
var map__10764 = top_item;
var map__10764__$1 = (((((!((map__10764 == null))))?(((((map__10764.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10764.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10764):map__10764);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10764__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10764__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10764__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e10763){var _e = e10763;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___10784 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5455__auto___10784)){
var seen_errors_10785 = temp__5455__auto___10784;
if(cljs.core.truth_(seen_errors_10785.has(self))){
} else {
seen_errors_10785.add(self);

var temp__5457__auto___10786 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5457__auto___10786)){
var sense_10787 = temp__5457__auto___10786;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_10787)].join('');
} else {
}
}
} else {
